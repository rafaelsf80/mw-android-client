...
public class CaseApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetAllCases extends CaseApiRequest<caseApi.model.CaseBeanCollection> {
    ...
    protected GetAllCases() {
      super(CaseApi.this, "GET", REST_PATH, null, caseApi.model.CaseBeanCollection.class);
    }
  ...
  public class GetCase extends CaseApiRequest<caseApi.model.CaseBean> {
    ...
    protected GetCase(java.lang.Long id) {
      super(CaseApi.this, "GET", REST_PATH, null, caseApi.model.CaseBean.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
  ...
  public class GetMyCases extends CaseApiRequest<caseApi.model.CaseBeanCollection> {
   ...
   *
   * @param content the {@link backend.caseApi.model.CaseBean}
   * @return the request
   */
  public UpdateCase updateCase(caseApi.model.CaseBean content) throws java.io.IOException {
  ...
  public class UpdateCase extends CaseApiRequest<Void> {
     ...
     * @since 1.13
     */
    protected UpdateCase(caseApi.model.CaseBean content) {
